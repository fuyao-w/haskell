...
/* package myproject-0.1.0.0 */
#ifndef VERSION_myproject
#define VERSION_myproject "0.1.0.0"
#endif /* VERSION_myproject */
#ifndef MIN_VERSION_myproject
#define MIN_VERSION_myproject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_myproject */
...
#define CURRENT_COMPONENT_ID "myproject-0.1.0.0-inplace-myproject"
